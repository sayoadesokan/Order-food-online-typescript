...
const generateSignature = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    return yield jsonwebtoken_1.default.sign(payload, Index_1.APP_SECRET, {
        expiresIn: '3d',
    });
});
...
const validateSignature = (req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (signature) {
        const payload = (yield jsonwebtoken_1.default.verify(signature.split(' ')[1], Index_1.APP_SECRET));
        req.user = payload;
        return true;
    }
    return false;
